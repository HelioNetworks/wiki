...
![](../.gitbook/assets/change_permissions%20%281%29.png)

Set the permissions of the `start.py` file to `755`.

![](../.gitbook/assets/755_permissions%20%283%29.png)
...
![](../.gitbook/assets/change_permissions%20%283%29.png)

And change `stop.py` to `755` permissions as well.

![](../.gitbook/assets/755_permissions%20%281%29.png)
